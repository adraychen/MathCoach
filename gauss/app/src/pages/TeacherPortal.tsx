...
import { LogOut, Users, UserPlus, BarChart3 } from 'lucide-react'

export function TeacherPortal() {
  const { profile, signOut } = useAuth()

  const cards = [
    { title: 'My Students', icon: Users, color: 'bg-blue-500' },
    { title: 'Create Student', icon: UserPlus, color: 'bg-green-500' },
    { title: 'Student Statistics', icon: BarChart3, color: 'bg-purple-500' },
  ]
